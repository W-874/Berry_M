...
namespace Item.Control.AD
{
    ...
    {
        [Header("Event")]
        public ADEvent OnClick;//单击时触发的事件
        public ADEvent OnDoubleClick;//双击时触发的事件
        float LastClick;
        [Header("Others")]
        ...
        {
            if (animator != null)
                animator.SetFloat("ClickCount", 1);
        }
        public void DoubleClick()
        {
            if (animator != null)
                animator.SetFloat("ClickCount", 2);
        }
        public void End()
        {
            if (animator != null)
                animator.SetFloat("ClickCount", 0);
        }
